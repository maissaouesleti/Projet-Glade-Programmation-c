...
GtkWidget *id;
GtkWidget *tree;
tree=lookup_widget(button,"rmtreeview");

id = lookup_widget(GTK_WIDGET(button),"rmchercherentry");


rmrecherche(tree,gtk_entry_get_text(GTK_ENTRY(id)));
}
...
GtkWidget *label;
gchar *id;
p=lookup_widget(button,"rmtreeview");
...
GtkWidget *tree;
GtkWidget *aff;
aff=lookup_widget(button,"acceuil");
tree=lookup_widget(aff,"rmtreeview");
rmafficher(tree);
}
...
GtkWidget* combo1;
GtkWidget* combo2,*labelex;


input1 = lookup_widget(button,"stentry4");
strcpy(c.id,gtk_entry_get_text(GTK_ENTRY(input1)));

radio1 = lookup_widget(button,"radiobutton1");
radio2 = lookup_widget(button,"radiobutton2");
radio3 = lookup_widget(button,"radiobutton3");
radio4 = lookup_widget(button,"radiobutton4");
labelex = lookup_widget(button,"label_id");
if(t==0)
...
spin1=lookup_widget(button,"spinbutton1");
spin2=lookup_widget(button,"spinbutton2");
spin3=lookup_widget(button,"spinbutton3");
spin4=lookup_widget(button,"spinbutton9");
spin5=lookup_widget(button,"spinbutton10");
...
combo1=lookup_widget(button,"stcombobox1");
combo2=lookup_widget(button,"stcombobox2");
...
add(c);
sendmail(" un capteur a été ajouter avec succés");
}else{

gtk_label_set_text(labelex,"ID déja utiliser");
}
}
}
...
{
GtkWidget *add;
add=lookup_widget(button,"ajouter");
...
type1=lookup_widget(button,"radiobutton5");
type2=lookup_widget(button,"radiobutton6");
type3=lookup_widget(button,"radiobutton7");
type4=lookup_widget(button,"radiobutton8");

captj=lookup_widget(button,"spinbutton4");
captm=lookup_widget(button,"spinbutton5");
capta=lookup_widget(button,"spinbutton6");

vmax=lookup_widget(button,"spinbutton7");
vmin=lookup_widget(button,"spinbutton8");

zone=lookup_widget(button,"comboboxentry7");
etage=lookup_widget(button,"comboboxentry8");

rech=lookup_widget(button,"entrychercher");
