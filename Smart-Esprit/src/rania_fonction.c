...
void sendmail(char body[])
{
        ...
        sprintf(cmd,"curl smtps://smtp.gmail.com:465 -v --mail-from \"capteur123@gmail.com:rania123+\" --mail-rcpt \"raniabenmajdouba@gmail.com\" --ssl -u capteur123@gmail.com:rania123+ -T mail.txt -k --anyauth"); // prepare command.
